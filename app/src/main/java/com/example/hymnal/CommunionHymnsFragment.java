...
import com.example.hymnal.databinding.FragmentCommunionHymnsBinding;

import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class CommunionHymnsFragment extends Fragment {

    FragmentCommunionHymnsBinding binding;
    HymnsAdapter hymnsAdapter;

    public CommunionHymnsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_communion_hymns, container, false);
    ...
    public void fetchCommunionHymns(){
        RetrofitInterface service = RetrofitClient.getRetrofitInstance().create(RetrofitInterface.class);
        Call<Category> call = service.getHymnsByCategory("5ee2165121aad32af0caad85");
        ...
        call.enqueue(new Callback<Category>() {
            ...
            public void onFailure(Call<Category> call, Throwable t) {
                Toast.makeText(getActivity(), "Unable to load communion category", Toast.LENGTH_SHORT).show();
            }
        });
    }
}